...
<body>
  ...
  <section class="bg-asset">
    ...
    <h1 class="title">ProductLevering</h1>
  ...
  $qrySelectBars = $dbconn->prepare("SELECT * FROM model INNER JOIN brand on brand.id = model.brandid WHERE brandname  LIKE :selector");
...
?>
...

    {
      ...
      echo "<td>" . $barData["modelname"] . "</td>";

      echo "<td>" . $barData["price"] . "</td>";

      echo "<td>" . $barData["categoryid"] . "</td>";

      echo "<td>" . $barData["brandid"] . "</td>";
