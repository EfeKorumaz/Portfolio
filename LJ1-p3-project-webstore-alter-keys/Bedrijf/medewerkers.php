...
<header>
      ...
      <ul>
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <div>
              <a href="../Overzichten/category.php">Categorieën</a>
  ...
  <section class="about">
    <h2>De medewerkers</h2>
    <p>In AlterKeys vormen Butch, Dylan, Efe en Max een team van toegewijde experts. Met passie voor keyboards en
      keycaps zorgen ze voor een unieke winkelervaring. Welkom bij AlterKeys, waar perfectie de standaard is.</p>
  </section>
