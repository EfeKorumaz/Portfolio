...
<body>
  ...
  $query = $dbconn->prepare(
    "SELECT category.modeltype, AVG(model.price) as gemiddeldeprijs
    FROM model
    INNER JOIN category ON model.categoryid = category.id
    GROUP BY category.modeltype
  ...
  ?>
    <table>
      ...
      <tr>
        <td><?php echo htmlspecialchars($row['modeltype']); ?></td>
