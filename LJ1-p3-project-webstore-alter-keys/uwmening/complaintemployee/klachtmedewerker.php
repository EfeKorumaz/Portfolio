...
<body>
  ...
  <section class="bg-asset">
    ...
    <h1 class="title">Klacht medeweweker</h1>
    ...
    <div class="mainbig">
      <div class="forum2">
        <form action="./feedback.php" method="post">
          ...
          <div>
            <textarea name="complaint" form="complaintform" placeholder="plaats hier uw klacht over de medewerker"
              required></textarea>
          </div>
