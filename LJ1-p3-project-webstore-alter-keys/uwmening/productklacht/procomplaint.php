...
<body>
  ...
  <section class="bg-asset">
    ...
    <h1 class="title">Klachten Producten</h1>
  ...
  <?php
    ...
    <div class="mainbig">
      <div class="forum2">
        <form action="./profeedback.php" method="post">
          <div class="name">
          ...
          <div>
            <br>
            <input type='text' name="complaint" placeholder="plaats hier uw klacht over het product"
              required></input>
              <br>
              <input type="text" name="compensation" placeholder="plaats hier wat u als compensatie wilt">
