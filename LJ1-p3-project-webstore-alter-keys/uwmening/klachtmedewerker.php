...
<body>
  ...
  <section class="bg-asset">
    ...
    <h1 class="title">Klachten indienen</h1>
  ...
  <section class="about">
    <h2>Heeft u een klacht over een van onze medewerkers? Dien hem hier in.</h2>
    <div class="complaintContainer">
        <input placeholder="Uw Email adres" type="text">
        <input placeholder="Naam medewerker" type="text">
        <input placeholder="scrijf uw klacht hier" type="text">
        <button>Klacht versturen</button>
        <h3>ik moet dit nog positioneren</h3>
    </div>
  </section>
