                ...
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                    ...
                    <label class="block text-sm">
                        ...
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="id" value="{{ old('id', $module->id) }}" type="text" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="title" value="{{ old('title', $module->title) }}" type="text" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <textarea
                            ...
                            focus:outline-none focus:shadow-outline" name="description" disabled>{{ old('description', $module->description) }}</textarea>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="start_date" value="{{ $module->start_date }}" type="text" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="end_date" value="{{ $module->end_date }}" type="text" disabled/>
                    </label>
