        ...
        <div class="card-body grid grid-cols-1 gap-6 lg:grid-cols-1">
            <div class="p-4">
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                      action="{{ route('admin.lessons.destroy', ['lesson' => $lesson->id]) }}" method="POST">
                    @method('DELETE')
                    @csrf
                    <label class="block text-sm">
                        ...
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="id" value="{{ old('id', $lesson->id) }}" type="text" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="title" value="{{ old('title', $lesson->title) }}" type="text" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <textarea
                            ...
                            focus:outline-none focus:shadow-outline" name="description" disabled>{{ old('description', $lesson->description) }}</textarea>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="start_date" value="{{ $lesson->start_date }}" type="text" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="end_date" value="{{ $lesson->end_date }}" type="text" disabled/>
                    </label>
