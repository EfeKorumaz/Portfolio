            ...
            <div class="p-4">
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="title" value="{{ old('title', $lesson->title) }}" type="text" required/>
                    </label>
                    <label class="block text-sm">
                        ...
                        <textarea
                            ...
                            id="description" rows="7" >{{ old('description', $lesson->description) }}</textarea>
                    </label>
                    <label class="block text-sm">
                        <span class="text-gray-700"> Duration</span>
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="duration" value="{{ old('duration', $lesson->duration) }}" type="number" min="3000" max="20000" required/>
                    </label>
