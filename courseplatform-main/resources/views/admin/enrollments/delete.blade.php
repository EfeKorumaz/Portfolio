                ...
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                    ...
                    <label class="block text-sm">
                        ...
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="id" value="{{ old('id', $enrollment->id) }}" type="text" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="title" value="{{ old('user_name', $enrollment->user->name) }}" type="text" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="title" value="{{ old('course_title', $enrollment->course->title) }}" type="text" disabled/>
                    </label>

                      <label class="block text-sm">
                        <span class="text-gray-700">Enroll Date</span>
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="title" value="{{ old('enroll_date', $enrollment->created_at) }}" type="text" disabled/>
                    </label>
                    ...
                    <div class="mt-4 flex gap-2">
                        ...
                        <a href="{{ route('admin.enrollments.index') }}" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150
                        bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700
                        focus:outline-none focus:shadow-outline-purple">Terug</a>
                    </div>
                </form>
            </div>
        </div>
