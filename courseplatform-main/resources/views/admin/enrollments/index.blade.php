            ...
            <div class="p-4">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-gray-50">
                        ...
                        <th class="px-4 py-3">Enroll Date</th>
                    ...
                    @foreach($enrollments as $enrollment)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-sm">{{$enrollment->user->name}}</td>
                            <td class="px-4 py-3 text-sm">{{$enrollment->course->title}}</td>
                            <td class="px-4 py-3 text-sm">{{$enrollment->created_at}}</td>
                            <td>
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route('admin.enrollments.delete', ['enrollment' => $enrollment->id]) }}">Enroll Out</a>
                                </div>
                            </td>
                        </tr>
